...
get_row_of_table("EncodeNoCrossover", "EncodeNoCrossover", "Encode keine Rekombination")

print("\t\\end{tabular}\n\t\\caption{Encode keine Rekombination: Auswertung der Rohdaten}\n\t\\label{table:encodeNoCrossoverRohdaten}\n\\end{table}")