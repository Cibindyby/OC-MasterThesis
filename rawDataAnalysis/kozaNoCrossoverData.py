...
get_row_of_table("KozaNoCrossover", "KozaNoCrossover", "Koza keine Rekombination")

print("\t\\end{tabular}\n\t\\caption{Koza keine Rekombination: Auswertung der Rohdaten}\n\t\\label{table:kozaNoCrossoverRohdaten}\n\\end{table}")