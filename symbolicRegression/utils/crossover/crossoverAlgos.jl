...
# Assuming the Runner, Chromosome, and other necessary types are defined elsewhere
include("../runnerMultipleParentsWithElitistMuLambda.jl")
include("../../standardCGP/chromosome.jl")

function single_point_crossover!(runner::runnerCrossoverMuLambda.Runner,
...
function multi_point_crossover!(runner::runnerCrossoverMuLambda.Runner,
                                new_population::Vector{Chromosome},
                                child1_id::Int,
                                child2_id::Int,
                                parent1_id::Int,
...
function uniform_crossover!(runner::runnerCrossoverMuLambda.Runner,
                            new_population::Vector{Chromosome},
                            child1_id::Int,
                            child2_id::Int,
                            parent1_id::Int,
...
function no_crossover!(runner::runnerCrossoverMuLambda.Runner,
                       new_population::Vector{Chromosome},
                       child1_id::Int,
                       child2_id::Int,
                       parent1_id::Int,
