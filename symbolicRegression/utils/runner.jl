module RunnerWithoutCrossoverMuLambda
  #runner for (1+lambda)-ES without crossover
    ...
    function Runner(params::CgpParameters,
        ...
        best_fitness = utilityFuncs.get_min(fitness_vals)
        parent_id = utilityFuncs.get_argmin(fitness_vals)
    ...
    function new_parent_by_neutral_search!(runner::Runner)
        min_keys = Int[]
        utilityFuncs.get_argmins_of_value(runner.fitness_vals, min_keys, runner.best_fitness)
