...
Wenn diese Behauptung für die Fitness-HPDI-Werte zutrifft, kann es keine HPDI-Intervalle geben, die ineinander liegen, denn dann würde ein kleinerer unterer Grenzwert ein größeres Intervall mit sich ziehen.
Allerdings fällt bereits bei der Betrachtung der ersten Tabelle \ref{table:encodeOnePointBayesian} auf, dass diese Beobachtung für die Fitness-Bewertung nicht zutrifft.
Ein Gegenbeispiel ergeben die beiden fett gedruckten HPDI-Werte dieser Tabelle, wobei ein Intervall in dem anderen liegt.
