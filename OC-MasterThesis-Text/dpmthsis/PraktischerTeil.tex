...
Da der verwendete BHOB Sampler mit und ohne Hyperband keine Einsparungen in der Rechenzeit ergeben hat, wurde weiterhin der einfach zu konfigurierende Random-Sampler verwendet. 
...
Es werden erste Erkenntnisse über die Effizienz der verschiedenen Rekombinationstypen gesammelt, indem beispielsweise die Anzahl der Rechenknoten miteinander verglichen werden.
...
Für die komplexeren Testszenarien können vor allem unterschiedliche Rekombinationarten und Rekombinationsraten-Arten miteinander verglichen werden.\\
...
Für Parity und Keijzer kann so eingeschätzt werden, durch welche Konfiguration ein CGP-Modell die Ausgangsprobleme schneller lösen kann als andere.
