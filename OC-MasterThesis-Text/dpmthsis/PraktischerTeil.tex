...
Für Boolesche Probleme werden den CGP-Modelle dabei weniger Iterationen Trainingszeit zur Verfügung gestellt als für SR Probleme, da diese in der Hyperparameteranalyse von Cui et al. mehr Rechenknoten brauchen und somit für jeweils eine Iteration mehr Rechenzeit benötigen als bei SR. \cite{cui_results}\\
