...
Zu beachten ist, dass $\mu <= \lambda$ gilt und die Hyperparameteranalysen nur für Parity und Keijzer (in der Tabelle durch P und K markiert) ausgeführt werden.
...
Diese werden anschließend in mehreren Durchläufen trainiert.
Für die Evaluation stehen daraufhin die Ergebnisse mehrerer CGP-Einstellungen zur Verfügung, die allerdings nicht die Ergebnisse der besten Parametersätze darstellen.
