...
Mit dem in dieser Arbeit verwendeten \emph{($\mu$ + $\lambda$)-Selektionsverfahren} wird dieser Ansatz verfolgt. 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\textwidth}
    	\centering
    	\includegraphics[scale = 0.55]{Bilder/BeispielUniformCrossover.png}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[scale = 0.55]{Bilder/GenotypNachMutation.png}
