...
def calvo(algorithm_labels, results):
    ...
    with open("BayesianAnalysis/bayesianResults/EncodeUniform/calvo.txt", "a") as file:
        file.write(f"{sample}")
...
def hpdi(result, name_algo):
    ...
    with open("BayesianAnalysis/bayesianResults/EncodeUniform/hpdi.txt", "a") as file:
        file.write(f"{name_algo} & {hdi} & {mean}\\\\\n\\hline\n")



with open("BayesianAnalysis/bayesianResults/EncodeUniform/hpdi.txt", "w") as file:
    file.write("")


with open("BayesianAnalysis/bayesianResults/EncodeUniform/calvo.txt", "w") as file:
    file.write("")
