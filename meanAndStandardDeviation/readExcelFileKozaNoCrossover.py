...
print(f'Creating plots for: KozaNoCrossover\n\n')
create_all_plots("KozaNoCrossover", "KozaNoCrossover", "Koza keine Rekombination")
...
for plotAndName in plots_array_fitness:
    ...
    plotAndName[0].savefig(f'Plots/Koza/NoCrossover/{plotAndName[1]}Fitness.png')
...
for plotAndName in plots_array_active_nodes:
    ...
    plotAndName[0].savefig(f'Plots/Koza/NoCrossover/{plotAndName[1]}ActiveNodes.png')
    plt.close(plotAndName[0])
