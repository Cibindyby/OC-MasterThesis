...
list_of_plots = [
    ['Koza One-Point Konstant: 0,125', 'Koza One-Point Konstant: 0,25', 'Koza One-Point Konstant: 0,375', 'Koza One-Point Konstant: 0,5', 'Koza One-Point Konstant: 0,625', 'Koza One-Point Konstant: 0,75', 'Koza One-Point Konstant: 0,875', 'Koza One-Point Konstant: 1,0'],
    ['Koza One-Point Clegg: 0,0005', 'Koza One-Point Clegg: 0,0015', 'Koza One-Point Clegg: 0,0025', 'Koza One-Point Clegg: 0,0035', 'Koza One-Point Clegg: 0,0045', 'Koza One-Point Clegg: 0,0055'],
    ['Koza One-Point One-Fifth: 0,125', 'Koza One-Point One-Fifth: 0,25', 'Koza One-Point One-Fifth: 0,375', 'Koza One-Point One-Fifth: 0,5', 'Koza One-Point One-Fifth: 0,625', 'Koza One-Point One-Fifth: 0,75', 'Koza One-Point One-Fifth: 0,875', 'Koza One-Point One-Fifth: 1,0']
]
...
for plotAndName in plots_array_fitness:
    ...
    plotAndName[0].savefig(f'Plots/Koza/OnePoint/{plotAndName[1]}Fitness.png')
...
for plotAndName in plots_array_active_nodes:
    ...
    plotAndName[0].savefig(f'Plots/Koza/OnePoint/{plotAndName[1]}ActiveNodes.png')
    plt.close(plotAndName[0])
