...
for plotAndName in plots_array_fitness:
    ...
    plotAndName[0].savefig(f'Endergebnisse/Parity/Plots/{plotAndName[1]}Fitness.png')
...
for plotAndName in plots_array_active_nodes:
    ...
    plotAndName[0].savefig(f'Endergebnisse/Parity/Plots/{plotAndName[1]}ActiveNodes.png')
    plt.close(plotAndName[0])
