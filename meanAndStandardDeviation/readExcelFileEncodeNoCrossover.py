...
print(f'Creating plots for: EncodeNoCrossover\n\n')
create_all_plots("EncodeNoCrossover", "EncodeNoCrossover", "Encode keine Rekombination")
...
for plotAndName in plots_array_fitness:
    ...
    plotAndName[0].savefig(f'Plots/Encode/NoCrossover/{plotAndName[1]}Fitness.png')
...
for plotAndName in plots_array_active_nodes:
    ...
    plotAndName[0].savefig(f'Plots/Encode/NoCrossover/{plotAndName[1]}ActiveNodes.png')
    plt.close(plotAndName[0])
