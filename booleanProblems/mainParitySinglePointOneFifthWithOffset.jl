...
function writeHpoResults(results::String)
    ...
    save_path = joinpath(["Experiments_Boolean", 
                            ...
                            "Crossover Rate Type 3 with offset",
                            "HPOResults.txt"])
...
function hpo(iteration::Int)
    ho = @hyperopt for i = 40000, #aus 400000 Kombinationen
        ...
        meanAusMehrerenIterationen(nbr_computational_nodes, population_size, crossover_start, elitism_number, crossover_offset)
    end
    ...
    writeHpoResults("Iteration $iteration: Parameter -> $beste_parameter; Ergebnis -> $bestes_ergebnis (nbr_computational_nodes, population_size, crossover_start, elitism_number, crossover_offset)")
end

function meanAusMehrerenIterationen(nbr_computational_nodes, population_size, crossover_start, elitism_number, crossover_offset)
